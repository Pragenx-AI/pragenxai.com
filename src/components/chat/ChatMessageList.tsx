                ...
                >
                    ...
                    {msg.role === 'user' && (
                        <div className="flex flex-col items-end group w-full">
                            <div className="bg-[#f4f4f4] dark:bg-white/5 text-gray-800 dark:text-gray-100 rounded-[2rem] px-6 py-2.5 shadow-sm w-fit max-w-[85%] lg:max-w-[70%]">
                                <p className="text-[15px] leading-relaxed lowercase font-medium whitespace-pre-wrap">{msg.content}</p>
                            </div>
