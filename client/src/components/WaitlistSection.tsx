...
export function WaitlistSection() {
  ...
  return (
    <section id="join" className="py-32 relative bg-white">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-12 md:p-20 text-center border border-border shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
            <Input 
              ...
              className="h-14 bg-white border-border text-foreground placeholder:text-muted-foreground focus:border-primary"
              value={email}
